-- ============================================================
-- MIDO XI — RUN THIS NEXT
--
-- Migrations 0009, 0010 and 0011, in order, in one file.
--   0009  connections     — invites, share scopes, RLS by scope
--   0010  video analysis  — saved frame reads
--   0011  referrals       — the affiliate programme
--
-- Paste into the Supabase SQL editor and run. Safe to re-run.
-- Afterwards, `node scripts/verify-schema.mjs` checks it landed.
-- ============================================================



-- ############################################################
-- 0009_connections.sql
-- ############################################################
