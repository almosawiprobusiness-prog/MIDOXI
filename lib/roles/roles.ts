...
export const ROLES: Record<RoleId, RoleDefinition> = {
  ...
  player: {
    ...
    nav: [
      ...
      { label: "Boards", href: "/app/tactics", icon: Grid3x3, hint: "Tactical pictures", status: "live", group: "more" },
      study,
  ...
  trainer: {
    ...
    nav: [
      ...
      { label: "Boards", href: "/app/tactics", icon: Grid3x3, hint: "Movement & drills", status: "live", group: "more" },
      study,
